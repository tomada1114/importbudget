"""Tests for the public importbudget API."""
...
import importbudget
from importbudget import __all__, __version__, add
...
class TestPackageMetadata:
    ...
    def test_version_falls_back_when_package_not_installed(self, monkeypatch):
        ...
        with monkeypatch.context() as patched:
            ...
            reloaded = importlib.reload(importbudget)

        assert reloaded.__version__ == "0.0.0+unknown"
        importlib.reload(importbudget)
